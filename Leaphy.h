...
#define MAX_BRANCH 25			// Maximum branch length
#define MIN_OMEGA 0.005			// Minimum value of omega in codon models (required to avoid interaction between small omega and long branch lengths)
