...
const double dJTTFreq[20] = {0.0767479,0.0516909,0.042645,0.0515439,0.019803,0.040752,0.0618299,0.0731519,0.022944,0.0537609,0.0919039,0.0586759,0.023826,0.040126,0.0509009,0.0687649,0.0585649,0.014261,0.032102,0.0660049};
...
//	CGammaPar(string Name, int Char, CPar* Rate,double Value = INITIAL_GAMMA, bool Optimise=true, double Lowbound = 0.01, double Upbound=MAX_ALFA,ParOp Oper=REPLACE);	// Constructor
	CGammaPar(string Name, int Char, CPar* Rate,double Value = 0.5, bool Optimise=false, double Lowbound = 0.01, double Upbound=MAX_ALFA,ParOp Oper=REPLACE);	// Constructor
