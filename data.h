...
public:
	...
	CData(string file, EDataType SpecType=NONE, bool AllowFail = false, streampos FilePos = 0, bool AllowGapClean = true, bool AllowCondense = true);
    ...
    void InputData(EDataType Type, vector <string> cInputSeq, vector <string> cInputName, vector <int> SiteLabels, bool AllowFail = false, bool AllowTrim = true, bool AlowCondense = true);
